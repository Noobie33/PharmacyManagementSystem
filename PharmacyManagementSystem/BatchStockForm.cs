...
namespace PharmacyManagementSystem
{
    ...
    ConfigurationManager.ConnectionStrings["PharmacyDB"].ConnectionString;
        ...
        void LoadMedicines()
        {
            ...
            SqlCommand cmd =
                new SqlCommand("SELECT MedicineId, MedicineName FROM Medicines", con);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand(
                @"INSERT INTO MedicineBatches
                  (MedicineId, BatchNo, ExpiryDate,
                   PurchasePrice, SalePrice, CurrentStockQty)
                  VALUES
                  (@medId, @batch, @exp, @buy, @sell, @qty)", con);
            ...
            cmd.Parameters.AddWithValue("@buy",
                decimal.Parse(txtPurchasePrice.Text));
            cmd.Parameters.AddWithValue("@sell",
